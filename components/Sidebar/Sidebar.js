...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className="w-16 fixed" aria-label="Sidebar">
        <div className="overflow-y-auto py-4 px-3 bg-gray-900 rounded-lg dark:bg-gray-800 min-h-[80vh] float-left shadow-2xl mt-20 ml-2">
