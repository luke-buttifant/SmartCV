...
export default function Sidebar() {
 function toggleOptions(){
    ...
    options.classList.toggle("xl:grid")
  }
  return (
    <>
      ...
      <aside className="w-16 fixed z-50" aria-label="Sidebar">
        ...
        <a href="#" onClick={toggleOptions} className="flex items-center p-2 text-base font-normal text-white rounded-lg dark:text-white hover:bg-slate-800 dark:hover:bg-gray-700">
                <svg className="w-6 h-6 text-white transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
              </a>
              <hr></hr>
